...
class SubmissionModel(models.BaseModel):
	def create_model(self, model_input, num_classes=2, l2_penalty=0.001, **unused_params):
		...
		net = slim.conv2d(net, 64, [3, 3], scope='conv11', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.conv2d(net, 64, [3, 3], scope='conv12', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.max_pool2d(net, [2, 2], scope='pool1')
		# net = slim.batch_norm(net, is_training=is_training, scope='bn_conv1')
		...
		net = slim.conv2d(net, 128, [3, 3], scope='conv22', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.max_pool2d(net, [2, 2], scope='pool2')
		# net = slim.batch_norm(net, is_training=is_training, scope='bn_conv2')
		# net = slim.dropout(net, 0.1, scope='dropout2')
		print(net.shape)

		net = slim.conv2d(net, 256, [3, 3], scope='conv31', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.conv2d(net, 256, [3, 3], scope='conv32', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.max_pool2d(net, [2, 2], scope='pool3')
		# net = slim.batch_norm(net, is_training=is_training, scope='bn_conv3')
		# net = slim.dropout(net, 0.1, scope='dropout3')
		print(net.shape)

		net = slim.conv2d(net, 512, [3, 3], scope='conv41', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.conv2d(net, 512, [3, 3], scope='conv42', weights_regularizer=slim.l2_regularizer(l2_penalty))
		net = slim.max_pool2d(net, [2, 2], scope='pool4')
		# net = slim.batch_norm(net, is_training=is_training, scope='bn_conv4')
		# net = slim.dropout(net, 0.1, scope='dropout3')
		print(net.shape)
